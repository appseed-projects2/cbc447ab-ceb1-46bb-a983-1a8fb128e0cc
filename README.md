...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-10-29 09:38`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/cbc447ab-ceb1-46bb-a983-1a8fb128e0cc.git
$ cd cbc447ab-ceb1-46bb-a983-1a8fb128e0cc
```
